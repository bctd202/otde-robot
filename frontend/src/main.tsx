...
export function App() {
  ...
  return <main>
    ...
    <div className={`mock-banner ${isMock?'mock':isDelayed?'delayed':'live'}`}><strong>{isMock?'DEMO MODE — MOCK OPTION DATA — DO NOT TRADE':isDelayed?'DELAYED MARKET DATA':'LIVE MARKET DATA'}</strong><span>{dashboard.provider_status.message}</span></div>
