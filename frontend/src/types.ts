...
export interface ParlayContract extends Contract { symbol:string; last:number; iv:number|null; theta:number|null; vega:number|null }
export interface ParlayCandidate {
  ...
  provider:string;data_mode:string;quote_freshness:string;verification_status:string;verification_reason:string;actionable:boolean;
}
